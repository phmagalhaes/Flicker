...
class _BuscarState extends State<Buscar> {
  ...
  final List<Map<String, String>> _filmes = [
    {
      ...
      "img": "assets/img/filmes/dragao.png",
      "ano": "2019",
      "genero": "Infantil/Aventura"
    },
    {
      "titulo": "Frozen: Uma Aventura Congelante",
      "img": "assets/img/filmes/frozen.png",
      "ano": "2013",
      "genero": "Infantil/Musical"
    },
    {
      "titulo": "Encanto",
      "img": "assets/img/filmes/encanto.png",
      "ano": "2021",
      "genero": "Fantasia"
    },
    {
      "titulo": "Monstros S.A.",
      "img": "assets/img/filmes/monstro.png",
      "ano": "2001",
      "genero": "Aventura/Comédia"
    },
    {
      "titulo": "Como perder um Homem em 10 dias",
      "img": "assets/img/filmes/homem.png",
      "ano": "2003",
  ...
  void _navegarParaPaginaEspecifica(Map<String, String> filme) {
    if (filme['titulo'] == "Como Treinar Seu Dragão 3") {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => Filme1(),
        ),
      );
    } else if (filme['titulo'] == "Frozen: Uma Aventura Congelante") {
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => Filme2(),
        ),
      );
    } else if (filme['titulo'] == "Encanto"){
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => Filme3(),
        ),
      );
    } else if (filme['titulo'] == "Monstros S.A."){
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => Filme4(),
        ),
      );
    } else if (filme['titulo'] == "Como perder um Homem em 10 dias"){
      Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => Filme5(),
        ),
      );
    }
  }

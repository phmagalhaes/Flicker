...
class _BuscarState extends State<Buscar> {
  ...
  final List<Map<String, String>> _filmes = [
    {
      'title': 'Monstros S.A.',
      'image': 'assets/img/filmes/filmesemelhante2.png',
    ...
    },
    {
      ...
      'image': 'assets/img/filmes/filmesemelhante1.png',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: MyColors.azulGradiente,
                ...
                Expanded(
                  child: TextFormField(
                    decoration: InputDecoration(
                      ...
                      filled: true,
                      fillColor: MyColors.azulBottomGradiente.withOpacity(0.5),

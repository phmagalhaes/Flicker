      ...
      body: Container(
        ...
        decoration: const BoxDecoration(
          gradient: LinearGradient(
            ...
            stops: [0, 0.5, 1],
            colors: [
              MyColors.azul, MyColors.azulescuro, MyColors.azulfinal
            ],
          ),
        ),
        child: Center(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: GridView.count(
                  ...
                  mainAxisSpacing: 10,
                  children: [
                    _buildProfileTile('assets/img/image.png', camillyController),
                    _buildProfileTile('assets/img/image 87.png', carolController),
                    _buildProfileTile('assets/img/image88.png', pedroHController),
                    _buildProfileTile('assets/img/image1.png', vitoriaController),
                  ],
                ),
              ),

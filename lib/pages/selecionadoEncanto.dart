...
class Encanto extends StatefulWidget {
  const Encanto({super.key});

  @override
  State<Encanto> createState() => _EncantoState();
}

class _EncantoState extends State<Encanto> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              Center(
                child: Image.asset('assets/catalogo/filmes/S.encanto.png'),
              ),
              const SizedBox(height: 20),
              Center(
                child: Column(
